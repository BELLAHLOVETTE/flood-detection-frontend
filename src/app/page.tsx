        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-10 md:p-14 shadow-md border border-blue-100">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link href="/register" className="bg-blue-700 hover:bg-blue-800 text-white text-base font-bold px-8 py-3.5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center gap-2">
