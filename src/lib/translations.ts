...
export const translations = {
  ...
  'auth.brand.tagline': {
    en: 'Satellite flood monitoring & early warning for safer communities',
    fr: 'Surveillance satellite des inondations et alerte précoce pour des communautés plus sûres',
  },
  'auth.brand.feat1': { en: 'Live flood risk map', fr: 'Carte des risques en direct' },
  'auth.brand.feat2': { en: 'Email alerts in English & French', fr: 'Alertes par email en anglais et français' },
  'auth.brand.feat3': { en: '25 years of rainfall data', fr: '25 ans de données de pluie' },
  'auth.tab.signin': { en: 'Sign In', fr: 'Connexion' },
  'auth.tab.signup': { en: 'Sign Up', fr: 'Inscription' },
  'auth.signin.title': { en: 'Welcome back', fr: 'Bon retour' },
  'auth.signin.sub': { en: 'Sign in to your admin dashboard', fr: 'Connectez-vous à votre tableau de bord' },
  'auth.signup.title': { en: 'Create account', fr: 'Créer un compte' },
  'auth.signup.sub': { en: 'Register as an authority or analyst', fr: 'Inscrivez-vous comme autorité ou analyste' },
  'auth.field.username': { en: 'Username', fr: 'Nom d\'utilisateur' },
  'auth.field.password': { en: 'Password', fr: 'Mot de passe' },
  'auth.field.email': { en: 'Email', fr: 'E-mail' },
  'auth.field.org': { en: 'Organisation (optional)', fr: 'Organisation (facultatif)' },
  'auth.forgot': { en: 'Forgot password?', fr: 'Mot de passe oublié ?' },
  'auth.btn.signin': { en: 'Sign In', fr: 'Se connecter' },
  'auth.btn.signup': { en: 'Create Account', fr: 'Créer le compte' },
  'auth.btn.wait': { en: 'Please wait…', fr: 'Veuillez patienter…' },
  'auth.no_account': { en: 'Don\'t have an account?', fr: 'Pas de compte ?' },
  'auth.have_account': { en: 'Already have an account?', fr: 'Vous avez déjà un compte ?' },
  'auth.link.signup': { en: 'Sign up', fr: 'S\'inscrire' },
  'auth.link.signin': { en: 'Sign in', fr: 'Se connecter' },
  'auth.back_public': { en: '← Back to public site', fr: '← Retour au site public' },
  'auth.err.fields': { en: 'Please fill in all fields.', fr: 'Veuillez remplir tous les champs.' },
  'auth.err.login': { en: 'Login failed. Please try again.', fr: 'Échec de la connexion. Veuillez réessayer.' },
  'auth.err.signup_required': { en: 'Username, email, and password are required.', fr: 'Le nom d\'utilisateur, l\'e-mail et le mot de passe sont requis.' },
  'auth.err.pw_short': { en: 'Password must be at least 8 characters.', fr: 'Le mot de passe doit comporter au moins 8 caractères.' },
  'auth.err.signup': { en: 'Registration failed. Please try again.', fr: 'Échec de l\'inscription. Veuillez réessayer.' },
  'auth.toast.signin': { en: 'Signed in successfully', fr: 'Connexion réussie' },
  'auth.success.title': { en: 'Account created', fr: 'Compte créé' },
  'auth.success.desc': {
    en: 'Your account has been created successfully. An administrator will review and activate your access before you can sign in.',
    fr: 'Votre compte a été créé avec succès. Un administrateur examinera et activera votre accès avant que vous puissiez vous connecter.',
  },
  'auth.success.next': { en: 'What happens next', fr: 'Et ensuite' },
  'auth.success.step1': { en: 'An administrator reviews your account', fr: 'Un administrateur examine votre compte' },
  'auth.success.step2': { en: 'Your account is activated once approved', fr: 'Votre compte est activé après approbation' },
  'auth.success.step3': { en: 'You can then sign in to the dashboard', fr: 'Vous pourrez alors vous connecter au tableau de bord' },
  'auth.success.goto': { en: 'Go to sign in', fr: 'Aller à la connexion' },
  'auth.success.public': { en: 'View public site', fr: 'Voir le site public' },
  // Forgot-password modal
  'auth.forgot.sent.title': { en: 'Check your email', fr: 'Vérifiez votre e-mail' },
  'auth.forgot.sent.desc': {
    en: 'If that address is registered, we\'ve sent a reset link. Please check your inbox — and your spam folder.',
    fr: 'Si cette adresse est enregistrée, nous avons envoyé un lien de réinitialisation. Vérifiez votre boîte de réception — et vos spams.',
  },
  'auth.forgot.done': { en: 'Done', fr: 'Terminé' },
  'auth.forgot.title': { en: 'Reset your password', fr: 'Réinitialiser votre mot de passe' },
  'auth.forgot.desc': { en: 'Enter your account email and we\'ll send you a reset link.', fr: 'Entrez l\'e-mail de votre compte et nous vous enverrons un lien.' },
  'auth.forgot.cancel': { en: 'Cancel', fr: 'Annuler' },
  'auth.forgot.send': { en: 'Send link', fr: 'Envoyer le lien' },
  'auth.forgot.sending': { en: 'Sending…', fr: 'Envoi…' },
  'auth.forgot.err': { en: 'Could not send reset link. Please try again.', fr: 'Impossible d\'envoyer le lien. Veuillez réessayer.' },
  // Reset password page
  'reset.done.title': { en: 'Password reset', fr: 'Mot de passe réinitialisé' },
  'reset.done.desc': { en: 'Your password has been updated. You can now sign in.', fr: 'Votre mot de passe a été mis à jour. Vous pouvez maintenant vous connecter.' },
  'reset.goto': { en: 'Go to sign in', fr: 'Aller à la connexion' },
  'reset.invalid.title': { en: 'Invalid reset link', fr: 'Lien de réinitialisation invalide' },
  'reset.invalid.desc': { en: 'This link is missing information. Request a new one from the sign-in page.', fr: 'Ce lien est incomplet. Demandez-en un nouveau depuis la page de connexion.' },
  'reset.back': { en: 'Back to sign in', fr: 'Retour à la connexion' },
  'reset.title': { en: 'Set a new password', fr: 'Définir un nouveau mot de passe' },
  'reset.sub': { en: 'Choose a strong password for your account', fr: 'Choisissez un mot de passe fort pour votre compte' },
  'reset.placeholder': { en: 'New password', fr: 'Nouveau mot de passe' },
  'reset.pw_short': { en: 'Password must be at least 8 characters.', fr: 'Le mot de passe doit comporter au moins 8 caractères.' },
  'reset.err': { en: 'Reset failed. The link may have expired.', fr: 'Échec. Le lien a peut-être expiré.' },
  'reset.btn': { en: 'Reset password', fr: 'Réinitialiser' },
  'reset.btn.loading': { en: 'Resetting…', fr: 'Réinitialisation…' },
